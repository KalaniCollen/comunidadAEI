...
@section('content')
    ...
    <section class="section">
        ...
        <div class="section__body mt-4">
            <div class="row profile__configuration">
                <div class="col-sm-12 col-md-3 col-lg-2">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="v-pills-datos-personales-tab" data-toggle="pill" href="#v-pills-datos-personales" role="tab" aria-controls="v-pills-datos-personales" aria-selected="true">Datos Personales</a>
                        <a class="nav-link" id="v-pills-datos-cuenta-tab" data-toggle="pill" href="#v-pills-datos-cuenta" role="tab" aria-controls="v-pills-datos-cuenta" aria-selected="false">Datos de la cuenta</a>
                    </div>
                </div>
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-datos-cuenta" role="tabpanel" aria-labelledby="v-pills-datos-cuenta-tab">
                            ...
                            {!! Form::open() !!}
                                ...
                                <button type="button" class="btn" data-toggle="modal" data-target="#modal-save-account" >
