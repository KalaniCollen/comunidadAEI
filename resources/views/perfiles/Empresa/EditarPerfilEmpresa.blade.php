                          ...
                          <div id="uploadimageModal" class="modal" role="dialog">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('Actualizar') }}">
                                      ...
                                      <div class="form-group{{ $errors->has('producto_empresa') ? ' has-error' : '' }}">
                                          <input id="Producto" type="checkbox" for="producto_empresa" onclick="producto()" name="Producto" value="1"@if ($perfilE->producto_empresa=="NINGUNO" or $perfilE->producto_empresa=="Ninguno" or $perfilE->producto_empresa=="")       @else  checked        @endif   >
