...
<section class="section">
    ...
    {{-- <div class="row">
        ...
        {!! Form::open(['route' => ['evento.store'], 'method' => 'POST', 'class' => 'col-md-3 col-lg-3']) !!}

            <div class="group">
                <label for="date"class="label">Fecha Inicio</label>
                <input type="date" name="fecha_fecha" id="" class="input" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
                <input type="time" name="fecha_hora" id="" class="input" value="{{ \Carbon\Carbon::now()->format('H:i') }}">
            </div>
    ...
    <form  method="POST" action="{{ route('evento.store') }}">
        ...
        <div class='input-group date' id='to'>
            <input type='text' name="fecha_final" id="to" class="form-control" readonly />
            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
        </div>
        <br>
        <br />
