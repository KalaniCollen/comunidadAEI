...
$('#Muestra').attr('src','/storage/img/download.png');
    ...
    $image_crop.result( {
      ...
      $.ajax({
        ...
        //  alert(data);
          ...
          $('#Carga').empty().html("<img src=/storage/Imagen_Usuario/"+data+" alt=Avatar class=img-thumbnail style=border-radius:150px; id=matrix>");
...
var ide = $("#id").val();
var dato="/storage/Imagen_Usuario/"+datos;
